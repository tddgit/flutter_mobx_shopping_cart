...
class AppDialog {
  ...
  static String _subtractOnClick({
  ...
  static void _cancelOnClick({BuildContext? context, int? quantity}) {
    if (context == null || quantity == null) return;
  ...
  static void _confirmOnClick({BuildContext? context, int? newQuantity}) {
    if (context == null || newQuantity == null) return;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildPlusMinusQuantity(textEditingController),
                const SizedBox(height: 40),
                _buildCancelConfirm(
                  context,
                  quantity,
  ...
  static Row _buildCancelConfirm(
      ...
      children: <Widget>[
        Container(
          ...
          child: IconButton(
            ...
            onPressed: () => textEditingController.text = _subtractOnClick(
              textEditingController: textEditingController,
            ),
          ),
        ),
        Container(
          ...
          child: TextField(
            ...
            maxLength: 3,
            onChanged: (onChangeQuantity) => textEditingController.text =
                _onTextFieldChange(quantity: onChangeQuantity),
          ),
        ),
        Container(
          decoration: BoxDecoration(
          ...
          child: IconButton(
            ...
            onPressed: () => textEditingController.text =
                _addOnClick(textEditingController: textEditingController),
          ),
        ),
      ],
    );
